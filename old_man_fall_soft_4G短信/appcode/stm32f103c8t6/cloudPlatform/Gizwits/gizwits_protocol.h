...
* @{
*/
#define PRODUCT_KEY "bb14c8928d6546bf8619719e98ddcd34"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "e5a6ea2171a448e8a9a07198d69d965e"
...
* @{
*/
#define fallSta_LEN                           1
#define xinlvSta_LEN                           1
#define tempSta_LEN                           1
#define xueyangSta_LEN                           1

#define xintiao_RATIO                         1
#define xintiao_ADDITION                      0
#define xintiao_MIN                           0
#define xintiao_MAX                           200
#define xintiao_LEN                           1
#define xueyang_RATIO                         1
#define xueyang_ADDITION                      0
#define xueyang_MIN                           0
#define xueyang_MAX                           100
#define xueyang_LEN                           1
#define tiwen_RATIO                         1
#define tiwen_ADDITION                      0
#define tiwen_MIN                           0
#define tiwen_MAX                           100
#define tiwen_LEN                           1
#define TEMP_MAX_RATIO                         1
#define TEMP_MAX_ADDITION                      0
#define TEMP_MAX_MIN                           33
#define TEMP_MAX_MAX                           43
#define TEMP_MAX_LEN                           1
#define HR_MAX_RATIO                         1
#define HR_MAX_ADDITION                      120
#define HR_MAX_MIN                           0
#define HR_MAX_MAX                           80
#define HR_MAX_LEN                           1
#define HR_MIN_RATIO                         1
#define HR_MIN_ADDITION                      0
#define HR_MIN_MIN                           0
#define HR_MIN_MAX                           90
#define HR_MIN_LEN                           1
#define SQO2_MIN_RATIO                         1
#define SQO2_MIN_ADDITION                      0
#define SQO2_MIN_MIN                           0
#define SQO2_MIN_MAX                           100
#define SQO2_MIN_LEN                           1
#define lat_RATIO                         0.01
#define lat_ADDITION                      0
#define lat_MIN                           0
#define lat_MAX                           3600000
#define lat_LEN                           4
#define lon_RATIO                         0.01
#define lon_ADDITION                      0
#define lon_MIN                           0
#define lon_MAX                           900000
#define lon_LEN                           4
...
typedef struct {
    ...
    bool valuexinlvSta;
    bool valuetempSta;
    bool valuexueyangSta;
    uint32_t valuexintiao;
    uint32_t valuexueyang;
    uint32_t valuetiwen;
    uint32_t valueTEMP_MAX;
    uint32_t valueHR_MAX;
    uint32_t valueHR_MIN;
    uint32_t valueSQO2_MIN;
    float valuelat;
    float valuelon;
    uint8_t valuePHONE[12];
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagfallSta:1;
    uint8_t flagxinlvSta:1;
    uint8_t flagtempSta:1;
    uint8_t flagxueyangSta:1;
    uint8_t flagxintiao:1;
    uint8_t flagxueyang:1;
    uint8_t flagtiwen:1;
    uint8_t flagTEMP_MAX:1;
    uint8_t flagHR_MAX:1;
    uint8_t flagHR_MIN:1;
    uint8_t flagSQO2_MIN:1;
    uint8_t flaglat:1;
    uint8_t flaglon:1;
    uint8_t flagPHONE:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuexintiao;
    uint8_t valuexueyang;
    uint8_t valuetiwen;
    uint8_t valueTEMP_MAX;
    uint8_t valueHR_MAX;
    uint8_t valueHR_MIN;
    uint8_t valueSQO2_MIN;
    uint32_t valuelat;
    uint32_t valuelon;
    uint8_t valuePHONE[12];
} devStatus_t;
